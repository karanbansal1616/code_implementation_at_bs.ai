...
class SSAQNAgent(agent.Agent):
    ...
    def create_model(self, embedding_dimensions, lstm_dimensions, dense_dimensions, optimizer, embeddings=None,
        ...
        #created new layer for state and action
        # encoder
        state_1=Dense(64,activation='tanh', name="dense_state_1")(embedding_state)
        action_1=Dense(64,activation='tanh', name="dense_action_1")(embedding_action)

        state_2=Dense(16,activation='tanh', name="dense_state_2")(state_1)
        action_2=Dense(16,activation='tanh', name="dense_action_2")(action_1)

        state_3=Dense(8,activation='tanh', name="dense_state_3")(state_2)
        action_3=Dense(8,activation='tanh', name="dense_action_3")(action_2)

        lstm_shared = LSTM(lstm_dimensions, name="lstm_shared")
        lstm_state = lstm_shared(state_3)
        lstm_action = lstm_shared(action_3)
